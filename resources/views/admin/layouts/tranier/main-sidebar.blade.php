<div class="container-fluid">
    ...
    <a href="{{ url('/dashboard') }}">
        ...
        <div class="clearfix"></div>
                    ...
                    <!-- menu title -->
                    <li class="mt-10 mb-10 text-muted pl-4 font-medium menu-title">programme name </li>
                    ...
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse"
                         data-target="#students-menu">
                         <i class="fas fa-user-graduate">
                            </i>students<div class="pull-right"><i class="ti-plus">
                                </i></div><div class="clearfix"></div></a>
                        <ul id="students-menu" class="collapse">
                            <li>
                                <a href="javascript:void(0);" data-toggle="collapse" 
                                data-target="#Student_information">Student_information<div class="pull-right">
                                    <i class="ti-plus"></i></div><div class="clearfix"></div></a>
                            ...
                            <li>
                                <a href="javascript:void(0);" data-toggle="collapse" 
                                data-target="#Students_upgrade">Students_Promotions<div class="pull-right"><i class="ti-plus"></i></div><div class="clearfix"></div></a>
                    ...
                    <!-- Settings-->
                    <li>
                        <a href="#"><i class="fas fa-cogs"></i><span 
